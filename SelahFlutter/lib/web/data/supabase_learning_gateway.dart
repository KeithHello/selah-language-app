...
class SupabaseLearningGateway implements LearningGateway {
  ...
  static Map<String, dynamic> sentenceToCloud(LearnSentence s, String user) => {
    ...
    if (s.sourceLanguage != null) 'source_language': s.sourceLanguage,
    if (s.targetLanguage != null) 'target_language': s.targetLanguage,
    if (s.generationModel != null) 'generation_model': s.generationModel,
    if (s.promptVersion != null) 'prompt_version': s.promptVersion,
    'category': s.category,
    'origin': s.origin,
